...
double interval =0.1; //Amr 
 //double interval =0.114; //Amr -- 8.75Hz case for 600vehicles in 3km
// double interval =0.286; //Amr -- 1500 vehicles
...
Simulator::Schedule(interPacketInterval, Pause); // Amr
//std::cout << "\n";
}
...
//std::string phyMode ("OfdmRate24MbpsBW10MHz"); //Amr
//std::string phyMode ("OfdmRate36Mbps"); //Amr
...
Config::Set ("/NodeList/*/DeviceList/*/$ns3::WifiNetDevice/Mac/$ns3::RegularWifiMac/DcaTxop/Queue/MaxDelay",TimeValue(interPacketInterval));// Amr
...
randomTimeRange->SetAttribute( "Max", DoubleValue( 0.1 ) ); //Amr
//randomTimeRange->SetAttribute( "Max", DoubleValue( 0.114 )); //Amr  
//randomTimeRange->SetAttribute( "Max", DoubleValue( 0.286)); //Amr 
...
//randomTimeRangePlatoon->SetAttribute( "Max",DoubleValue(0.114 ) );	//Amr
 // randomTimeRangePlatoon->SetAttribute( "Max",DoubleValue( 0.286 ) );	//Amr
